...
var attachFieldToNode = (0, _ramda.curry)(function (node, createNodeField, context, fields) {
  ...
  var fieldValue = (0, _ramdaAdjunct.isFunction)(getter) ? getter(node, context) : node[name];
  ...
  var value = (0, _ramdaAdjunct.isFunction)(transformer) ? transformer(fieldValue, node, context) : fieldValue;
